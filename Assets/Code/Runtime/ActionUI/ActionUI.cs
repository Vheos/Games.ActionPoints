namespace Vheos.Games.ActionPoints
{
    ...
    public class ActionUI : ABaseComponent
    {
        ...
        public void ExpandButtons(ActionPhase phase, bool instantly = false)
        {
        ...
        public void CollapseButtons(bool instantly = false)
        {
            foreach (var buttonWheelByPhase in _buttonsWheelsByPhase)
                buttonWheelByPhase.Value.Get<Expandable>().TryCollapse(instantly);
        }
        public void CollapseAll(bool instantly = false)
        {
            CollapseButtons(instantly);
            Points.Get<Expandable>().TryCollapse(instantly);
        }
